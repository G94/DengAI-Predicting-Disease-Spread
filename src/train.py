...
def main(args):
    try:
        data_train_path = args.data_preprocess
    ...
    name_experiment = 'train_autoservicios_piloto_{}'.format(execution_date)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_preprocess', required = True, help = "ruta del archivo del entrenamiento")
    ...
    """
    python train.py  --data_train_path train_autoservicio_cliente_piloto_202007031503.csv   --name_experiment Autoservicio_SKU
    """